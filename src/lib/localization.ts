...
export const translations: Translations = {
  en: {
    ...
    toasts: {
      ...
      exportingDescEncrypted: 'Please wait while the encrypted backup file is being prepared.',
  ...
  ar: {
    ...
    toasts: {
      ...
      exportingDescEncrypted: 'يرجى الانتظار بينما يتم تجهيز ملف النسخ الاحتياطي المشفر.',
