...
exportPhone: 'Phone',
    ...
    patient: {
        managementTitle: "Patient Referrals",
        allPatientsTitle: "All Patient Referrals",
        allPatientsDesc: "A centralized view of all patients referred by your doctors.",
        managementDesc: "Manage patients referred by Dr. {doctorName}",
        addPatient: "Add Patient",
        noPatients: "No patients have been referred by this doctor yet.",
        noPatientsOverall: "No patients have been referred yet.",
        ...
        deletePatientDesc: "Are you sure you want to delete this patient record?",
  ...
  ar: {
    ...
    patient: {
        managementTitle: "إحالات المرضى",
        allPatientsTitle: "جميع إحالات المرضى",
        allPatientsDesc: "عرض مركزي لجميع المرضى المحالين من أطبائك.",
        managementDesc: "إدارة المرضى المحالين من د. {doctorName}",
        addPatient: "إضافة مريض",
        noPatients: "لا يوجد مرضى محالون من هذا الطبيب بعد.",
        noPatientsOverall: "لم يتم إحالة أي مرضى بعد.",
        ...
        deletePatientDesc: "هل أنت متأكد من أنك تريد حذف سجل هذا المريض؟",
